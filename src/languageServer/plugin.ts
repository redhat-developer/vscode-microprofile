...
function setJarExtensionsIfExists(obj: MicroProfileContribution, section: { jarExtensions: unknown }, extensionPath: string): void {
...
function setDocumentSelectorIfExists(obj: MicroProfileContribution, section: { documentSelector: unknown }): void {
